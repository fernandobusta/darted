/*----- constants -----*/
var bombImage = "<img src='{% static '/images/mineswp/bomb.png' %}>";
var flagImage = '<img src="../images/mineswp/flag.png">';
var wrongBombImage = '<img src="../images/mineswp/wrong-bomb.png">'
var sizeLookup = {
...
function buildTable() {
  ...
  <tr>
    <td class="menu" id="window-title-bar" colspan="${size}">
      <div id="window-title"><img src="{% static 'images/mine-menu-icon.png' %}"> Minesweeper</div>
